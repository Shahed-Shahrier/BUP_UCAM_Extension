(() => {
    ...
    const config = Object.freeze({
        ids: {
            evaluationPanel: "bup-ucam-evaluation-panel",
            updatePanel: "ctl00_MainContainer_UpdatePanel2",
            marksTable: "ctl00_MainContainer_gvgvExamMarkSummaryDetails",
            finalSection: "bup-ucam-final-section",
        },
        classes: {
            generatedRow: "bup-ucam-row",
            totalRow: "bup-ucam-total-row",
            missingSource: "bup-ucam-source-missing",
            manualInput: "bup-ucam-manual-input",
            currentFloor: "bup-ucam-current-floor",
            evaluationButton: "bup-ucam-evaluation-button",
            rowIcon: "bup-ucam-row-icon",
            rowIconTotal: "bup-ucam-row-icon-total",
            markBadge: "bup-ucam-mark-badge",
            markPending: "bup-ucam-mark-pending",
            markAchieved: "bup-ucam-mark-achieved",
            markLimit: "bup-ucam-mark-limit",
            totalBadge: "bup-ucam-total-badge",
            totalLimit: "bup-ucam-total-limit",
            finalHeader: "bup-ucam-final-header",
            finalHeaderIcon: "bup-ucam-final-header-icon",
            summary: "bup-ucam-summary-banner",
            provisionalNote: "bup-ucam-provisional-note",
            tableWrap: "bup-ucam-final-table-wrap",
            finalTable: "bup-ucam-final-table",
            rowNumber: "bup-ucam-row-number",
            status: "bup-ucam-status",
            statusAchieved: "bup-ucam-status-achieved",
            statusImpossible: "bup-ucam-status-impossible",
            footnote: "bup-ucam-footnote",
        },
        selectors: {
            radio: "input[type='radio']",
            manualMarkInput: "[data-bup-ucam-manual-key]",
